...
statement: (expression | reservation | assignment | returnStatement | assertion) SEMICOLON;
block: CURL_L (statement | conditional)* CURL_R;
...
// conditionals
conditional: branch | loop | for_loop | for_each_loop;
